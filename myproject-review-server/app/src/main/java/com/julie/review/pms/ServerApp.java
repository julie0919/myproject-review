...
import com.julie.review.pms.table.BoardTable;
import com.julie.review.pms.table.DataTable;
import com.julie.review.pms.table.MemberTable;
import com.julie.review.pms.table.ProjectTable;
import com.julie.review.pms.table.TaskTable;
      ...
      while (true) {
        ...
        if (dataTable != null) {
          ...
          try {
            ...
            sendResponse(out, "error", e.getMessage() != null ? e.getMessage() : e.getClass().getName());
          }
